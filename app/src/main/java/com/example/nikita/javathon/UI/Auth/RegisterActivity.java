...
import com.example.nikita.javathon.utils.CheckNetwork;
...
public class RegisterActivity extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            email = extras == null ? "" : extras.getString(Constants.TAG_LOGIN);
        } else {
            email = savedInstanceState.getString(Constants.TAG_PASSWORD);
        }
